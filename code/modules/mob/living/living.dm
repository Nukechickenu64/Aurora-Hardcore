...
/mob/living/LateLogin()
	. = ..()
	if(paneledhud == TRUE)
		winset(src, "mapwindow.rpanel", "view-size=32x480")
		winset(src, "mapwindow.lpanel", "view-size=96x480")
...
/mob/living/Logout()
	...
	if(paneledhud == TRUE)
		...
		winset(src, "mapwindow.map", "anchor1=15,0;anchor2=95,100;size=620,480")
